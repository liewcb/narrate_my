...
class ARSessionManager {
  ...
  /// Pauses the AR session safely on Android/iOS without rebuilding view
  Future<void> pause() async {
    try {
      await _channel.invokeMethod<void>("pause");
    } catch (e) {
      print('Error pausing AR session: ' + e.toString());
    }
  }

  /// Resumes the AR session safely on Android/iOS without rebuilding view
  Future<void> resume() async {
    try {
      await _channel.invokeMethod<void>("resume");
    } catch (e) {
      print('Error resuming AR session: ' + e.toString());
    }
  }
