          ...
          children: [
            ...
            Positioned(
              ...
              child: ARNotificationBanner(
                ...
                // (an AR-overlay-only concept). The banner splits these
                // into its own Available/Nearby sections internally, so
                // it needs every fetched marker with geometry, sorted
                // nearest-first.
