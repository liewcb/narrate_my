...
class _AddCustomPlaceScreenState extends State<AddCustomPlaceScreen> {
  ...
  Widget _buildDayStopRow(ItineraryStop stop) {
    return Padding(
      ...
      child: Row(
        children: [
          const Icon(Icons.access_time, size: 16, color: AppColors.inkFaint),
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(color: AppColors.moduleBorder),
                  ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      if (place.rating > 0) ...[
                        const Icon(Icons.star, size: 14, color: AppColors.accentSoft),
          ...
          child: Column(
            ...
            children: [
              ...
              if (proximity != null) ...[
                ...
                Row(
                  children: [
                    const Icon(Icons.directions, size: 16, color: AppColors.inkFaint),
                    const SizedBox(width: 6),
                    Text(
        ...
        Row(
          children: [
            ...
            Icon(
              ...
              color: plan.success ? AppColors.green : AppColors.error,
              size: 18,
            ),
            const SizedBox(width: 6),
            Text(
