...
class EditItineraryScreen extends StatelessWidget {
          ...
          TextButton(
            ...
            child: Text(
              ...
              style: AppTextStyles.button.copyWith(
                color: AppColors.primaryContainer, //[cite: 1]
                fontSize: 14,
              ),
            ),
          ),
        ...
        children: [
          ...
          Positioned(
            ...
            child: FloatingActionButton(
              onPressed: () {},
              backgroundColor: AppColors.secondaryActive, //[cite: 1]
              foregroundColor: AppColors.onSecondary, //[cite: 1]
              elevation: 4,
    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: AppTextStyles.button.copyWith(color: AppColors.textPrimary), //[cite: 1]
        ),
  ...
  Widget _buildMapSection() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.surfaceCard, //[cite: 1]
        borderRadius: BorderRadius.circular(AppRadius.card), //[cite: 1]
        boxShadow: const [
          BoxShadow(
            color: AppColors.shadow, //[cite: 1]
            blurRadius: 8,
            offset: Offset(0, 2),
          ),
        ],
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.secondaryActive.withOpacity(0.9), //[cite: 1]
          borderRadius: BorderRadius.circular(AppRadius.pill), //[cite: 1]
        ),
        child: Text(
          'Day 1 route',
          style: AppTextStyles.labelSm.copyWith(color: AppColors.onSecondary), //[cite: 1]
        ),
      ),
    );
  }
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: isActive
                        ? AppColors.secondaryActive //[cite: 1]
                        : AppColors.surfaceInactive, //[cite: 1]
                    border: isActive
                        ? null
                        : Border.all(color: AppColors.outlineVariant.withOpacity(0.3)), //[cite: 1]
                  ),
                  alignment: Alignment.center,
                  child: Text(
                    number,
                    style: AppTextStyles.button.copyWith(
                      color: isActive ? AppColors.onSecondary : AppColors.textSecondary, //[cite: 1]
                    ),
                  ),
                ),
                if (!isLast)
                  Expanded(
                    child: CustomPaint(
                      painter: _DashedLinePainter(
                        color: AppColors.outlineVariant, //[cite: 1]
                      ),
                    ),
                  ),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Batu Caves', style: AppTextStyles.button.copyWith(color: AppColors.textPrimary)), //[cite: 1]
                  const SizedBox(height: 4),
                  const Text('08:30 – 10:30', style: AppTextStyles.labelSm), //[cite: 1]
                ],
              ),
              Row(
                children: [
                  _buildIconBtn(Icons.edit, AppColors.surfaceInactive, AppColors.textSecondary), //[cite: 1]
                  const SizedBox(width: 8),
                  _buildIconBtn(Icons.delete, AppColors.dangerBg, AppColors.dangerText), //[cite: 1]
                ],
              ),
            ],
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.background, //[cite: 1]
              borderRadius: BorderRadius.circular(8),
              border: Border.all(color: AppColors.divider), //[cite: 1]
            ),
            child: const Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(title, style: AppTextStyles.button.copyWith(color: AppColors.textPrimary)), //[cite: 1]
              const SizedBox(height: 4),
          ...
          IconButton(
            ...
            color: AppColors.textSecondary, //[cite: 1]
            style: IconButton.styleFrom(backgroundColor: AppColors.background), //[cite: 1]
            onPressed: () {},
          ),
        ],
      ),
  ...
  Widget _buildDetailRow(IconData icon, String text) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(icon, size: 20, color: AppColors.primaryContainer), //[cite: 1]
        const SizedBox(width: 12),
        Expanded(
          child: Text(text, style: AppTextStyles.bodySm.copyWith(color: AppColors.textSecondary)), //[cite: 1]
        ),
      ],
    );
  }
  ...
  Widget _buildStickyBottomBar(BuildContext context) {
    return Positioned(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.background.withOpacity(0.9), //[cite: 1]
          boxShadow: const [
            BoxShadow(
              color: AppColors.shadow, //[cite: 1]
              blurRadius: 20,
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: AppColors.primaryContainer, //[cite: 1]
...
class _TravelContextText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Icon(icon, size: 16, color: AppColors.textMuted), //[cite: 1]
