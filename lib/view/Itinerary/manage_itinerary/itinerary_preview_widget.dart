          ...
          children: [
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                color: AppColors.primaryTerracotta, //[cite: 4]
                shape: BoxShape.circle, //[cite: 4]
              ),
              child: Text(
                '${stop.dayIndex}', //[cite: 4]
                style: const TextStyle(
                  color: AppColors.surfaceCard, //[cite: 4]
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: AppTextStyles.bodySm.copyWith(
                          color: AppColors.textSecondary, //[cite: 4]
                        ),
                      ),
                    ],
                  ),
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          weather, //[cite: 4]
                          style: AppTextStyles.bodySm.copyWith(
                            color: AppColors.textMuted, //[cite: 4]
                          ),
                        ),
                      ],
                    ),
            ...
            const Icon(Icons.chevron_right, color: AppColors.textMuted), //[cite: 4]
          ],
        ),
      ),
    );
