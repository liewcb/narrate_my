...
class _AddFromBookmarksScreenState extends State<AddFromBookmarksScreen> {
    ...
    return Container(
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(color: AppColors.inkFaint, fontSize: 14, fontFamily: 'Inter'),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(30),
                      border: Border.all(
                        color: isSelected ? AppColors.green : AppColors.moduleBorder,
                      ),
                    ),
                    child: Text(
                      days[index],
  ...
  //           Container(
  //             decoration: BoxDecoration(
  //               border: Border(top: BorderSide(color: AppColors.moduleBorder.withOpacity(0.3))),
  //             ),
  ...
  //                     child: Row(
  //                       children: [
  //                         Icon(Icons.hourglass_empty, color: AppColors.accent, size: 18),
  //                         const SizedBox(width: 8),
  //                         Column(
  //                           crossAxisAlignment: CrossAxisAlignment.start,
  //                           children: [
