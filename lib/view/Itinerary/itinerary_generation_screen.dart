...
class _Step5GenerationBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // When generation completes successfully, navigate immediately to the
    // final screen (no separate preview screen, no auto-save — the traveler
    // explicitly clicks Save on the final screen to persist).
